    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                    <h3 class="card-title">
                        <?= 'Jumlah Keluarga Lingkungan / Stasi ' . $lingkungan['nama']; ?>
                    </h3>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                    <h3 class="card-title">
                        <?= 'Jumlah Umat Lingkungan / Stasi ' . $lingkungan['nama']; ?>
                    </h3>
                </div>
            </div>
            <div class="card-body pb-0">
        ...
        <div class="card">
            <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                    <h3 class="card-title">
                        <?= 'Demografi Umur Lingkungan / Stasi ' . $lingkungan['nama']; ?>
                    </h3>
                </div>
            </div>
            <div class="card-body pb-0">
        ...
        <div class="card">
            <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                    <h3 class="card-title">
                        <?= 'Demografi Golongan Darah Lingkungan / Stasi ' . $lingkungan['nama']; ?>
                    </h3>
                </div>
            </div>
            <div class="card-body pb-0">
        ...
        <div class="card">
            <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                    <h3 class="card-title">
                        <?= 'Demografi Pekerjaan Lingkungan / Stasi ' . $lingkungan['nama']; ?>
                    </h3>
                </div>
            </div>
            <div class="card-body pb-0">
        ...
        <div class="card">
            <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                    <h3 class="card-title">
                        <?= 'Demografi Pendidikan Terakhir Lingkungan / Stasi ' . $lingkungan['nama']; ?>
                    </h3>
                </div>
            </div>
            <div class="card-body pb-0">
        ...
        <div class="card">
            <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                    <h3 class="card-title">
                        <?= 'Demografi Umat Yang Masih Bersekolah Lingkungan / Stasi ' . $lingkungan['nama']; ?>
                    </h3>
                </div>
            </div>
            <div class="card-body pb-0">
