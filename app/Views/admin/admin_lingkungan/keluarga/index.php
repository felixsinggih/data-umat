    ...
    <div class="card">
        <div class="card-body pb-0">
            <div class="form-group">
                <form action="/lingkungan/keluarga" method="post">
                    <?= csrf_field(); ?>
            ...
            <div class="form-group">
                <a href="/lingkungan/keluarga/add" class="btn btn-outline-primary"><i class="fas fa-plus"></i> Tambah Data</a>
            </div>
            <div class="form-group">
                    ...
                    <tbody>
                        ...
                        foreach ($keluarga as $data) : ?>
                            <tr align="center">
                                ...
                                <td>
                                    <a href="/lingkungan/keluarga/<?= $data['id_keluarga'] ?>" class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a>
                                </td>
                            </tr>
                        <?php $i++;
                        endforeach;
