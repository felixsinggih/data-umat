...
<row>
    <div class="card">
        ...
        <div class="card-body pb-0">
            <div class="form-group">
                <a href="/lingkungan/keluarga/<?= $keluarga['id_keluarga'] ?>" class="btn btn-secondary"><i class="fas fa-undo"></i> Kembali</a>
            </div>
            <div class="row">
    ...
    <div class="card">
        ...
        <div class="card-body pb-0">
            <div class="form-group">
                <a href="/lingkungan/anggota/edit/<?= $anggota['id_anggota'] ?>" class="btn btn-success"><i class="fas fa-pencil-alt"></i> Edit</a>
                <form action="/lingkungan/anggota/delete/<?= $anggota['id_anggota'] ?>" method="post" class="d-inline">
                    <?= csrf_field(); ?>
