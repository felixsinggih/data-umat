    ...
    <div class="card">
        <div class="card-body pb-0">
            <div class="form-group">
                <a href="/admin/lingkungan/add" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Baru</a>
            </div>
            <div class="form-group">
                    ...
                    <tbody>
                        ...
                        foreach ($lingkungan as $data) : ?>
                            <tr align="center">
                                ...
                                <td>
                                    <a href="/admin/lingkungan/edit/<?= $data['id_lingkungan'] ?>" class="btn btn-sm btn-success"><i class="fas fa-pencil-alt"></i> Edit</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
