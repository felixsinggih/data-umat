...
class Anggota extends BaseController
{
    ...
    public function add($idKeluarga)
    {
        ...
        return view('admin/admin_lingkungan/keluarga/anggota/add', $data);
    }
    ...
    public function addData($idKeluarga)
    {
        if (!$this->validate([
            ...
            return redirect()->to('/lingkungan/anggota/add/' . $idKeluarga)->withInput();
        }
    ...
    public function edit($idAnggota)
    {
        ...
        return view('admin/admin_lingkungan/keluarga/anggota/edit', $data);
    }
    ...
    public function editData($idAnggota)
    {
        if (!$this->validate([
            ...
            return redirect()->to('/lingkungan/anggota/edit/' . $idAnggota)->withInput();
        }
        ...
        if (!empty($cek)) {
            ...
            return redirect()->to('/lingkungan/anggota/edit/' . $data['id_anggota'])->withInput();
        }
        ...
        if ($this->db->transStatus() == false) {
            ...
            return redirect()->to('/lingkungan/anggota/' . $data['id_anggota']);
        }
    }
    ...
    public function detail($idAnggota = false)
    {
        ...
        $anggota = $this->anggotaModel->findAnggotaByLingkungan($idLingkungan, $idAnggota)->first();
        if (empty($anggota)) {
        ...
        return view('admin/admin_lingkungan/keluarga/anggota/detail', $data);
    }
    ...
    public function delete($idAnggota)
    {
        ...
        if ($this->db->transStatus() == false) {
            ...
            return redirect()->to('/lingkungan/keluarga/' . $anggota['id_keluarga']);
        } elseif ($this->db->transStatus() == true) {
